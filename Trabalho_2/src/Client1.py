...
def execute_transaction(client_id, operations, items, values, transaction_id):
...
thread_1 = threading.Thread(
    ...
    args=("client1", ["read", "write", "commit"], ["x", "x"], [None, 42], "T1")
)

thread_2 = threading.Thread(
    target=execute_transaction,
    args=("client2", ["read", "write", "commit"], ["x", "x"], [None, 99], "T2")
)
